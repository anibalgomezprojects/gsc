...
function checkCreditCard ($cardnumber, $cardname, &$errornumber, &$errortext) {
  ...
  $ccErrors [0] = "<p class=\"wrong\">Unknown card type</p>";
  $ccErrors [1] = "<p class=\"wrong\">No card number provided</p>";
  $ccErrors [2] = "<p class=\"wrong\">Credit card number has invalid format</p>";
  $ccErrors [3] = "<p class=\"wrong\">Credit card number is invalid</p>";
  $ccErrors [4] = "<p class=\"wrong\">Credit card number is wrong length</p>";
